...
| `e05_profile_audit_gtest` | 2209 tests verifying all 315 E05 profiles (276 handcrafted [wavelet×scale×category] + 6 compact-AE phase00 + 32 phase01 + debug) parse + validate |
