...
and scores them, no classifier). Writes `results/thesis/phase00/*_paraconsistent.csv`.
...
.venv/bin/python scripts/pipeline/e05/02_e05_apply_winner.py \
  --winners results/thesis/phase00/winners.json --fused voice   # or: --fused eeg
```
...
Writes EER/AUC to `results/thesis/phase01/`.
