---
name: snn-parameter-bounds-enforcer
...
**Current clamping location:** `include/layers/spiking/LeakyBPTT.hpp` inside `forward()` — forward-time clamping as a safety net. Post-optimizer clamping (as this skill recommends) is not yet implemented.
