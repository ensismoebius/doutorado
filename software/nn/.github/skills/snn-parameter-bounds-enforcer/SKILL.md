...
**Current clamping location:** `include/layers/spiking/LifBPTT.hpp` inside `forward()` — forward-time clamping as a safety net. Post-optimizer clamping (as this skill recommends) is not yet implemented.
