...
if(TARGET example1)
    target_compile_options(example1 PRIVATE -w -fno-lto)
    set_property(TARGET example1 PROPERTY INTERPROCEDURAL_OPTIMIZATION OFF)
    set_target_properties(example1 PROPERTIES CXX_CLANG_TIDY "")
endif()