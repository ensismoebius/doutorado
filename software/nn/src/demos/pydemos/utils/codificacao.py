...
def calcular_taxa_max_adaptativa(
    ...
    *,
    ...
    - Define `taxa = qtde_de_spikes_esperada_por_passo / mean_val` (aproximação) e
    ...
    Exemplo numérico:
    - `mean_val = 0.5`, `qtde_de_spikes_esperada_por_passo = 0.1` -> taxa ~= 0.2
    ...
    if mean_val < eps:
        ...
        taxa = qtde_de_spikes_esperada_por_passo / (mean_val + eps)
    ...
    *,
    ...
    if adaptativo:
        taxa_max = calcular_taxa_max_adaptativa(
            x,
            qtde_de_spikes_esperada_por_passo=alvo_spikes_por_passo,
            taxa_max_min=0.02,
            taxa_max_max=0.50,
        )
