/**
 * @file src/experiments/04/experiment04_launcher.cpp
 * @brief Lightweight launcher for Experiment04 CLI.
 *
 * This translation unit owns only process-level concerns (log level, stream
 * redirection, and CLI handoff). Experiment logic lives in
