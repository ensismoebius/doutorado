...
namespace lstm_snn_autoencoder_comparisom
{
...
class Trainer
{
   public:
    ...
    explicit Trainer(nn::models::lstm::LSTMAutoencoder& model, const Experiment04Config& cfg)
        : model_(model),
          cfg_(cfg),
   ...
   private:
    nn::models::lstm::LSTMAutoencoder& model_;
