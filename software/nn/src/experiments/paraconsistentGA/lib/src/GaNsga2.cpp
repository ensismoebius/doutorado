...
// constrained_dominates / fast_non_dominated_sort / assign_crowding_distance are now
// thin inline forwarders in GaNsga2.hpp onto the shared core (include/ga/Nsga2Core.hpp).
