...
void Wav::setCallbackFunction(void (*callbackFunction)(std::vector<long double>& signal,
...
inline void Wav::write16Res2Channel(std::ofstream& ofs)
{
    ...
    unsigned char waveformdata_lsb_left, waveformdata_lsb_right, waveformdata_msb_left,
