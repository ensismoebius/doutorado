...
- Validation performed: rebuilt experiment04 target after the change and confirmed successful link without the prior ProgressManager string-overflow warnings.
