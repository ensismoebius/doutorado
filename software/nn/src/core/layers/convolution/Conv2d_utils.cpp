...
auto Conv2dImpl<Backend>::get_or_compute_indices(
    int batch_size, int input_height, int input_width) const
...
template <typename Backend>
void Conv2dImpl<Backend>::add_bias_optimized(typename Conv2dImpl<Backend>::Tensor& matrix,
    const typename Conv2dImpl<Backend>::Tensor& bias,
...
auto Conv2dImpl<Backend>::reshape_output_optimized(
    const typename Conv2dImpl<Backend>::Tensor& matrix,
    int batch_size,
    int output_height,
    int output_width) const -> typename Conv2dImpl<Backend>::Tensor
{
