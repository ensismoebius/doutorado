...
auto main(int /*argc*/, char * /*argv*/[]) -> int {
  ...
  //   // This will generate spike trains for n_samples, each with input_dim features over n_steps
  //   time steps std::vector<Eigen::MatrixXf> spike_trains =
  ...
  //   std::vector<Tensor *> params = {&linear1->weight, &linear1->bias, &linear2->weight,
  //   &linear2->bias};
  ...
  //           static_cast<float>(batches.size()) << "\n";
  //         }
  //     }
