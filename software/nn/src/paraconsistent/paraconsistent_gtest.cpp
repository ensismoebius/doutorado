...
void initializeClasses(std::map<std::string, std::vector<std::vector<long double>>>& arrClasses,
...
TEST(paraconsistentTest, distanceTo1_0)
{
    ...
    long double certaintyDegree_G1 = calcCertaintyDegree_G1(alpha, betha);
    long double contradictionDegree_G2 = calcContradictionDegree_G2(alpha, betha);
    long double distanceTo1_0 =
