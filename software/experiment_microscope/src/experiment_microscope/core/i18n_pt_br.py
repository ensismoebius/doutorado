...
CATALOG = {
    ...
    "\n<b>What this shows.</b> Every window of one meeting01 <b>fold</b> pushed through\nthe trained autoencoder, then its 32-number <b>latent</b> vector squeezed to 2-D\n(or 3-D) so you can see the structure.\n<br><br>\n<b>This is a PROJECTED view</b>, not a pipeline number.\n<b>PCA</b> (Principal Component Analysis) rotates onto the directions of greatest\nspread — distances stay roughly meaningful, and the title shows how much\nvariability the 2 axes keep. <b>t-SNE</b> only preserves <i>who is near whom</i>;\ngaps and cluster sizes are not meaningful.\n<br><br>\n<b>Colour</b> = digit spoken, or speaker (legend/​controls). Well-separated\ncolours mean the latent space encodes that property. <b>Click a point</b> to\nselect that window everywhere else in the app.\n<br><br>\nThe forward passes run on a background thread — press <i>Project</i> and wait for\nthe status line.\n":
        "\n<b>O que este painel mostra.</b> Todas as janelas de uma <b>dobra</b> do\nmeeting01 passadas pelo autoencoder treinado; depois, o <b>vetor latente</b> de\n32 números de cada uma é reduzido a 2-D (ou 3-D) para você enxergar a estrutura.\n<br><br>\n<b>Esta é uma visão PROJETADA</b>, não um número do pipeline.\nO <b>PCA</b> (Análise de Componentes Principais) gira os dados para as direções\nde maior dispersão — as distâncias continuam mais ou menos significativas, e o\ntítulo mostra quanta variabilidade os 2 eixos preservam. O <b>t-SNE</b> só\npreserva <i>quem está perto de quem</i>; os espaços e os tamanhos dos grupos não\ntêm significado.\n<br><br>\nA <b>cor</b> indica o dígito falado, ou o locutor (veja a legenda e os\ncontroles). Cores bem separadas mostram que o espaço latente codifica aquela\npropriedade. <b>Clique num ponto</b> para selecionar aquela janela em todo o\nresto do aplicativo.\n<br><br>\nAs passagens pela rede rodam numa thread em segundo plano — aperte <i>Projetar</i>\ne aguarde a linha de status.\n",
