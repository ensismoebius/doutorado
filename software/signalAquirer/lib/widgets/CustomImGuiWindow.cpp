...
CustomImGuiWindow<DerivedClass>::CustomImGuiWindow(const std::string &title, ImVec2 dimensions, ImVec4 color)
{
    // Initialize GLFW
    if (!glfwInit())
    {
    ...
    if (window == NULL)
    {
        throw std::runtime_error("No window could be initialized");
    }
...
template <typename DerivedClass>
CustomImGuiWindow<DerivedClass>::~CustomImGuiWindow()
{
    // Cleanup
...
template <typename DerivedClass>
void CustomImGuiWindow<DerivedClass>::update()
{
    static_cast<const DerivedClass *>(this)->update();
}

template <typename DerivedClass>
void CustomImGuiWindow<DerivedClass>::startUp()
{
    static_cast<DerivedClass *>(this)->startUp();
}

template <typename DerivedClass>
void CustomImGuiWindow<DerivedClass>::run()
{
