...
- [ ] 47. Criar seção específica para Threshold-Dependent Batch Normalization (TDBN). ✓ seção criada (`chapters/07-bibliographicRevision.tex:904`, "Normalização em Lote Dependente do Limiar (tdBN)") --- falta ainda a parte "ESTUDAR!!!" (aprofundamento pessoal), por isso mantido em aberto.
