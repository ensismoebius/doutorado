\begin{tikzpicture}[transform shape]
	...
	% Início
	\tikzstyle{startstop} = [circle, rounded corners, minimum width=1cm, minimum height=1cm, text centered, fill=flowStartEndColor, text=black, font=\sffamily\bfseries]
	
	% Processo
	\tikzstyle{process} = [rectangle, rounded corners, minimum width=3cm, minimum height=1cm, text centered, fill=flowProcessColor, font=\sffamily\bfseries, inner sep=0.4cm]
	
	% Decisão
	\tikzstyle{decision} = [diamond, minimum width=3cm, minimum height=1cm, text centered, fill=flowDecisionColor, text=black, font=\sffamily\bfseries, aspect=3]
	
	% Estilos das setas
	\tikzstyle{arrow} = [thick,->,>=stealth, draw=flowArrowColor, line width=1.5mm]
