	...
	box/.style={draw, rectangle, rounded corners=3pt,
		...
		fill=green, font=\small\sffamily\bfseries},
	fwd/.style={->, >=stealth, draw=gray, line width=1.5mm},
	bwd/.style={->, >=stealth, dashed, draw=gray, line width=1.5mm},
	...
	{\tikz[baseline=-0.5ex]\draw[->,>=stealth,dashed,draw=gray,line width=1.5mm](1.2cm,0)--(0,0); gradiente retropropagado};
