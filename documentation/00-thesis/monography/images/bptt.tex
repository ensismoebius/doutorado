	...
	box/.style={draw, rectangle, rounded corners=3pt,
		...
		fill=flowProcessColor, font=\small\sffamily\bfseries},
	fwd/.style={->, >=stealth, draw=flowArrowColor, line width=1.5mm},
	bwd/.style={->, >=stealth, dashed, draw=flowArrowColor, line width=1.5mm},
	...
	\node[lbl, below=1.6cm of r2, text=black]
	{\tikz[baseline=-0.5ex]\draw[->,>=stealth,dashed,draw=flowArrowColor,line width=1.5mm](1.2cm,0)--(0,0); gradiente retropropagado};
