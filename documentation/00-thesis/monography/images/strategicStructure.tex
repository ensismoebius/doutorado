		...
		\begin{tikzpicture}
			...
			% Estilos das setas
			\tikzstyle{seta} = [thick,->,>=stealth, draw=flowArrowColor, line width=1.5mm]
			
			% Estilos do processo
			\tikzstyle{processo} = [rectangle, rounded corners, minimum width=3cm, minimum height=1cm, text centered, fill=flowProcessColor, font=\sffamily\bfseries, inner sep=0.4cm]
			
			% Estilos Início / Fim
			\tikzstyle{iniFim} = [circle, rounded corners, minimum width=1cm, minimum height=1cm, text centered, fill=flowStartEndColor, text=black, font=\sffamily\bfseries]
