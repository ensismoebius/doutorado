\begin{tikzpicture}[scale=2.5]
	...
	\foreach \i in {0,1,2,3,4} {
		...
		\filldraw[fill=diagramInputColor] (input_node\i) circle (0.15cm);
	...
	\foreach \i in {0,1,2} {
		...
		\filldraw[fill=diagramHiddenColor] (hidden_node\i) circle (0.15cm);
	...
	\foreach \i in {0,1,2,3,4} {
		...
		\filldraw[fill=diagramOutputColor] (output_node\i) circle (0.15cm);
