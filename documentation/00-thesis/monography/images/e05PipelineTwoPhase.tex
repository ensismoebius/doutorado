...
\node[script, below=of p00] (rank)
    {\texttt{thesis\_phase00\_rank.py}\\ menor $D_{\text{verdade}}$ por sinal $\rightarrow$ \texttt{winners.json}};
\node[script, below=of rank] (apply)
    {\texttt{thesis\_apply\_winner.py}\\ injeta o vencedor nos $32$ perfis da Fase 01};
