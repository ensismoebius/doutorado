...
\node[proc, below=of start] (p00)
    {\textbf{Fase 00} --- varrer $23$ wavelets $\times$ $3$ escalas $\times$ $2$ categorias $\times$ $2$ sinais\\ ($+$ 6 autoencoders compactos --- SNN-AE e ANN-AE): $288$ execuções, \texttt{classifier.enabled=false}};
