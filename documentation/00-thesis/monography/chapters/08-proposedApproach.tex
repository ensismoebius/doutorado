	...
	\section{Estrutura da estratégia proposta}
		...
		\subsection{Protocolo experimental em duas fases}
			...
			\subsubsection{Fase 00 --- construção e seleção do vetor de características}
				...
				\par Considerando os dois sinais, a Fase 00 tem $2 \times (138 + 3) = 282$ execuções de ranking. O vetor fundido não é varrido aqui: ele é montado na Fase 01, a partir dos vencedores de cada sinal.
