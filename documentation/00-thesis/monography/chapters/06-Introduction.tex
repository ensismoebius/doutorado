\chapter{Introdução}
	\section{Considerações Iniciais e Objetivos}
		...
		\subsection{Objetivos}
			...
			\par Iniciar com a criação de vetores de características usando \textit{autoencoders} e análise com \textit{wavelets packet transform}, e classificá-los com redes neurais de pulso profundas residuais.
