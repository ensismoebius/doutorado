\begin{table}[h]
	...
	\colorlet{tcA}{tableSignalLabelColor}
	\colorlet{tcD}{tableDetailBandColor}
	\colorlet{tcC}{tableApproxBandColor}
	\colorlet{tcB}{tableSignalValuesColor}
	\begin{center}
		\caption[Exemplo numérico de \textit{wavelet-packet} - porção das baixas frequências]{Exemplo numérico de \textit{wavelet-packet} Haar aplicada ao vetor da Tabela \ref{tab:regularWaveletExample} (porção das baixas frequências). Tabela completa no \autoref{sec:aplicaWavelet}.}
...
\begin{table}[h]
	\newcommand{\mc}[3]{\multicolumn{#1}{#2}{#3}}
	\colorlet{tcA}{tableSignalLabelColor}
	\colorlet{tcC}{tableDetailBandColor}
	\colorlet{tcD}{tableApproxBandColor}
	\colorlet{tcB}{tableSignalValuesColor}
	\begin{center}
		\caption[Exemplo numérico de \textit{wavelet-packet} - porção das altas frequências]{Exemplo numérico de \textit{wavelet-packet} Haar aplicada ao vetor da Tabela \ref{tab:regularWaveletExample} (porção das altas frequências). Tabela completa no \autoref{sec:aplicaWavelet}.}
