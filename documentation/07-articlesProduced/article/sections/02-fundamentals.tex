...
\label{sec:fundamentals}
	...
	\subsection{Leaky Integrate and Fire Neuron}
		...
		\par LIF is one of the simplest neuron models in SNNs, still, it can be applied successfully to most of the problems SNNs can be used.

		\par Unlike a standard neuron, LIF takes the sum of weighted inputs and apply some \textit{leakage}, which decreases in some degree the sum, before it passes to its activation function. 
