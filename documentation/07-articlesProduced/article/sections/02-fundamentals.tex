...
\label{sec:fundamentals}
	...
	\subsection{Leaky Integrate and Fire Neuron}
		...
		\par LIF behaves much like Resistor-Capacitor circuit as illustrated in Figure \ref{fig:rcmodel}. Here $R$ is resistance to the leakage, $I_{in}$ the input current, $C$ the capacitance, $U_{mem}$ means the accumulated action potential and $v$ is a switch that lets the capacitor discharge (i.e. emit a spike) when some potential threshold is reached.
