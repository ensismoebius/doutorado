...
% Source: hand-authored from src/experiments/guayaquil/profiles/article-loso.json.
\begin{table}[!t]
...
% regenerated by scripts/pipeline/guayaquil/02_ and 04_; placeholders keep the
...
\newcommand{\resultsForDataset}[2]{%
  ...
  \centering\footnotesize
  \input{data/article_loso_#1_significance_recording.tex}
  \label{tab:sig-#1}
  \end{table}
  \begin{figure}[!t]
    \centering
