...
% F1 removed: Metrics paragraph declares classification metrics out of scope
% (FSDD has no anomaly labels); listing F1 here contradicted that.
\node[main, below = 14mm of enc] (met)
  {MSE, MAE, $R^2$, spike rate\\energy, timing, params, MACs};
