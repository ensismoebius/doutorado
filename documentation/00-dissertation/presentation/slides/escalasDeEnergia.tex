	...
	\frametitle{Bandas críticas de energia}
		\only<1>{
			...
			\begin{columns}
				...
				\column{0.5\textwidth}
					\begin{itemize}
						\item \textbf{BARK:} 20, 100, 200, 300, 400, 510, 630, 770, 920, 1080, 1270, 1480, 1720, 2000, 2320, 2700, 3150, 3700, 4400, 5300, 6400, 7700, 9500, 12000, 15500 \cite{doi:10.1121-1.1908630}.
						\item \textbf{MEL:} 20, 160, 394, 670, 1000, 1420, 1900, 2450, 3120, 4000, 5100, 6600, 9000, 14000 \cite{beranek1949acoustic}.
					\end{itemize}
			\end{columns}
		}
		\only<2>{
