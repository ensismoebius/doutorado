\begin{frame}
	...
	\only<6>{
		...
		\par Deve seguir os mesmos protocolos descritos anteriormente porém captando ambos os sinais fonados e imaginados simultaneamente;
	}
		...
		\begin{textblock*}{\linewidth}(.3cm,.7cm)
			\begin{figure}[t]
				...
				\subfloat[0.5\textwidth][Protocolo de coleta silenciosa]{
					\scalebox{0.6}{
						\input{../monography/images/coletaSilenciosa.tex}
					}
					\label{fig:coletaSilenciosa}
				}
				\subfloat[0.5\textwidth][Protocolo de coleta ruidosa]{
					\scalebox{0.6}{
						\input{../monography/images/coletaRuidosa.tex}
					}
