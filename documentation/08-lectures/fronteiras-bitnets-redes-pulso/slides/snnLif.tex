\begin{frame}
	...
	% [SOFTWARE] SNN -> LIF | tau=5, r=5, v_th=1 ja batem com o exemplo
	% numerico do quadro 2; Play com parametros padrao para o quadro 3
	\abrirNoSoftware{SNN \textrightarrow{} LIF}{snn.lif}
\end{frame}
