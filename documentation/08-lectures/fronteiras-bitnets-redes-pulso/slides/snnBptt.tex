\begin{frame}[shrink]
	...
	\begin{columns}[T]
		\column{.55\linewidth}
		\resizebox{!}{3.3cm}{\input{../../00-thesis/monography/images/bptt.tex}}
		\column{.4\linewidth}
		\begin{itemize}
		...
		\end{equation*}
		\par\tiny Exemplo, $T=3$: $\frac{\partial \mathcal{L}_1}{\partial W}=0{,}10$, $\frac{\partial \mathcal{L}_2}{\partial W}=-0{,}05$, $\frac{\partial \mathcal{L}_3}{\partial W}=0{,}20$ $\Rightarrow$ soma $=0{,}25$.
	\end{columns}
	\vspace{2pt}
